...
public class frmGiangVien extends javax.swing.JPanel
{
    ...
    private void loaddata()
    {
        try {
            ...
            String sSelect = "SELECT * from GiangVien";
            ...
            String a[] = {"Mã giảng viên","Họ tên","Giới tính","Ngày sinh","Địa chỉ","Email","Số điện thoại","Mã môn học"};
            ...
            tblGiangVien.setModel(modelTable);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (!c.checkID(txtMaGV.getText()))
        {
            ...
            return;
        else if (ngaysinh == null || ngaysinh.equals(""))
        {
        ...
        {
             String s = "insert into GiangVien values('"+ magv + "',N'" + hoten + "',N'" + a + "','" + ngaysinh + "',N'" + diachi + "','" + email + "','" + sdt + "','" + mamh + "')";
    ...
    private void btnCapnhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapnhatActionPerformed
        ...
        else
        {
            ...
            {                                                 
            String s = "update SinhVien Set magv ='" + magv + "',HoTenGV=N'" + hotengv + "',gioitinh=N'" + a + "',gioitinh=N'" + a + "' ,ngaysinh='" + ngaysinh + "',diachi=N'" + diachi + "',email='" + email +"' ,sdt='" + sdt + "' where magv= '"+magv+"'";
                int i = db.ThemXoaSua(s);
                if (i>0) loaddata();    
                ResetForm();                
            btnThem.setEnabled(true);
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        {        
           ...
           if (b == JOptionPane.YES_OPTION)
                {
                   if (tblGiangVien.getSelectedRow() < 0) 
                   { 
                        JOptionPane.showMessageDialog(this,"Phải chọn một dòng để xóa!");
                        return;
                    }
                        int row = tblGiangVien.getSelectedRow();
                        String maGV_to_del = (String)tblGiangVien.getValueAt(row, 0);
                        String s = "delete from GiangVien where magv='" + maGV_to_del+"'";
                        int i = db.ThemXoaSua(s);
                        ResetForm();
                        if (i>0) loaddata();        
                }
    ...
    private void cboMaMHItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cboMaMHItemStateChanged
           String tenmh = cboMaMH.getSelectedItem().toString();
            try {
