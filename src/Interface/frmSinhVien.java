...
public class frmSinhVien extends javax.swing.JPanel
{
    ...
    private void loaddata()
    {
       try {
            ...
            String sSelect = "SELECT * from SinhVien";
            ...
            String a[] = {"Mã sinh viên","Họ tên","Hệ đạo tạo","Giới tính","Ngày sinh","Địa chỉ","Số điện thoại","Mã lớp"};
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        else
        {
                ...
                String s = "insert into SinhVien values('"+ masv + "',N'" + hotensv + "',N'" + hedt + "',N'" + a + "','" + ngaysinh + "',N'" + diachi + "','" + sdt + "','" + malop + "')";
    ...
    private void btnCapnhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapnhatActionPerformed
        ...
        else
        {
            ...
            {   
                String s = "update SinhVien Set masv ='" + masv + "',HotenSV=N'" + hotensv + "',hedaotao=N'" + hedt + "',gioitinh=N'" + a + "' ,ngaysinh='" + ngaysinh + "',diachi=N'" + diachi + "',sdt='" + sdt + "' where masv= '"+masv+"'";
                int i = db.ThemXoaSua(s);
                if (i>0) loaddata();    
                ResetForm();                
                btnThem.setEnabled(true);
            ...
            int b = JOptionPane.showConfirmDialog(null, "Bạn chắc chắn muốn xóa dữ liệu này?", "Thông báo", JOptionPane.YES_NO_OPTION);
                if (b == JOptionPane.YES_OPTION)
                {
                   ...
                   { 
                        ...
                        String maSV_to_del = (String)tblSinhVien.getValueAt(row, 0);
                        String s = "delete from SinhVien where masv='" + maSV_to_del+"'";
                        int i = db.ThemXoaSua(s);
                        ResetForm();
                        if (i>0) loaddata();        
                }
    ...
    private void loaddulieuvaocbb() {
          try {
            String sSQL = "SELECT Malop FROM Lop";
