...
public class frmMonHoc extends javax.swing.JPanel
{
    ...
    private void loaddata()
    {
        try {
            ...
            String sSelect = "SELECT * from MonHoc";
            ...
            String a[] = {"Mã môn học","Tên môn học","Số tín chỉ","Hình thức thi","Học kỳ","Phòng học"};
    ...
    private void initComponents() {
        ...
        txHTT = new javax.swing.JTextField();
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtPhongHoc, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                    .addComponent(txtHocKy, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                    .addComponent(txHTT))
                .addGap(181, 181, 181))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel3)
                    .addComponent(jLabel7)
                    .addComponent(txHTT, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtHocKy, txtMaMH, txtPhongHoc, txtSoTinChi, txtTenMH});
    ...
    private void tblMonHocMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMonHocMouseClicked
        ...
        txHTT.setText(tblMonHoc.getValueAt(tblMonHoc.getSelectedRow(), 3).toString());
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        {
             String s = "insert into MonHoc values('"+ maMH + "',N'" + tenMH + "','" + stchi + "',N'" + htThi + "','" + hky + "','" + phongHoc + "')";
    ...
    private void btnCapnhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapnhatActionPerformed
        ...
        else
        {
            ...
            String s = "update MonHoc Set maMH='" + maMH + "',TenMH=N'" + tenMH + "',soTinchi='" + stchi + "',HinhThucThi=N'" + htThi + "',HocKy='" + hky + "' where maMH = '"+maMH+ "'";
            int i = db.ThemXoaSua(s);
            if (i>0) loaddata();    
            ResetForm();
            btnThem.setEnabled(true);
        ...
        else
        {
            ...
            if (b == JOptionPane.YES_OPTION)
            {
               int row = tblMonHoc.getSelectedRow();
                        String maMH_to_del = (String)tblMonHoc.getValueAt(row, 0);
                        String s = "delete from Lop where MaMH='" + maMH_to_del+"'";
                        int i = db.ThemXoaSua(s);
                        ResetForm();
                        if (i>0) loaddata();    
            }
    ...
    private javax.swing.JTextField txHTT;
