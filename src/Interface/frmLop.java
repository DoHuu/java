...
public class frmLop extends javax.swing.JPanel
{
    ...
    private void loaddata()
    {
        try {
            ...
            String a[] = {"Mã lớp","Tên lớp","Khóa học","Mã khoa"};
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        {             
             String s = "insert into Lop values('"+ malop + "',N'" + tenlop + "','" + khoahoc + "','" + makhoa + "')";
    ...
    private void btnCapnhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapnhatActionPerformed
        ...
        {
            String s = "update Lop Set tenlop=N'" + tenlop + "',khoahoc='" + khoahoc + "' where malop = '"+malop+ "'";
            int i = db.ThemXoaSua(s);
            if (i>0) loaddata();    
            ResetForm();
            btnThem.setEnabled(true);
        ...
        else
        {
                ...
                if (b == JOptionPane.YES_OPTION)
                {
                   ...
                   { 
                        ...
                        String maLop_to_del = (String)tblLop.getValueAt(row, 0);
                        String s = "delete from Lop where malop='" + maLop_to_del+"'";
                        int i = db.ThemXoaSua(s);
                        ResetForm();
                        if (i>0) loaddata();        
                }
    ...
    private void loaddulieuvaocbb() {
          try {
            String sSQL = "SELECT makhoa FROM khoa";
